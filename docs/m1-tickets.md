...
## M1-01 — Surprise computation (stage 5) — [#24](https://github.com/diykorey/fortuneteller/issues/24)
...
## M1-02 — Complete the CPI core slice + surprise-response mapping (config) — [#25](https://github.com/diykorey/fortuneteller/issues/25)
...
## M1-03 — Conditional-direction resolver (the headline feature) — [#26](https://github.com/diykorey/fortuneteller/issues/26)
...
## M1-04 — Enrich `replay()` to resolve conditional cells — [#27](https://github.com/diykorey/fortuneteller/issues/27)
...
## M1-05 — CPI episodes + goldens + intent `expect`s — [#28](https://github.com/diykorey/fortuneteller/issues/28)
...
## M1-06 — Free live path: FRED + econ-calendar connector — [#29](https://github.com/diykorey/fortuneteller/issues/29)
...
## M1-07 — `predict` CLI subcommand (optional live-validation) — [#30](https://github.com/diykorey/fortuneteller/issues/30)
